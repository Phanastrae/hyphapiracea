...
public class ItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider wrapperLookup) {
        ...
        // copy hyphapiracea tags
        this.copy(HyphaPiraceaBlockTags.AZIMULDEY, HyphaPiraceaItemTags.AZIMULDEY);
        this.copy(HyphaPiraceaBlockTags.FAE_TOXIN, HyphaPiraceaItemTags.FAE_TOXIN);
        this.copy(HyphaPiraceaBlockTags.HYPHAL_CONDUCTOR, HyphaPiraceaItemTags.HYPHAL_CONDUCTOR);
    }
}
